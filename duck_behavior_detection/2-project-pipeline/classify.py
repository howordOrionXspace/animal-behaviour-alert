...
"""
Function: Model entity reasoning and calculation module

Load trained model weights to calculate input image data 
"""
...
class recognitionModel(object):
    _defaults = {
        "model_path": "runs/train/reg/weight.h5",
        "classes_path": "runs/train/reg/classes.txt",
        "input_shape": [224, 224],
    }
