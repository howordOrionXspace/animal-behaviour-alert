...
"""
Function: Image inference calculation module
"""
...
class imageInference(object):
    def __init__(self, modelDir="runs/train/", pic_path='test.jpg'):
        """
        initialization
        """
    ...
    def inference(self):
        ...
        # Detection
        resImg, resData = detect.inference(self.pic_path)
...
if __name__ == "__main__":
    ai = imageInference(pic_path='test.jpg')
    ai.inference()
